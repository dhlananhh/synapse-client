...
export default function CommentItem({ postId, comment, onCommentDeleted, onCommentUpdated }: CommentItemProps) {
            ...
            <div className="ml-auto">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem onClick={ () => setIsDeleteDialogOpen(true) } className="text-destructive focus:text-destructive"><Trash2 className="mr-2 h-4 w-4" />Delete</DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
          ) }
