...
export default function ManageFlairsDialog({
  isOpen,
  onOpenChange,
  community
    ...
    <>
      ...
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              Manage Flairs for c/{ community.slug }
            </DialogTitle>
            <DialogDescription>
              Create, edit, and delete the post flairs for your community.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="py-4 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              </h4>
              {
                isLoading ? (
                  ...
                  >
                    <Badge
                      style={
                        { backgroundColor: flair.color, color: "#FFFFFF" }
                      }
                    >
                      { flair.name }
                    </Badge>
                    <div className="flex gap-1">
                      ...
                      <Button
                        ...
                        onClick={ () => handleDeleteClick(flair) }
                      >
            ...
            >
              <h4 className="font-semibold">
                { editingFlairId ? "Edit Flair" : "Create New Flair" }
              </h4>
              <div>
                <Input
                  { ...register("name") }
                  placeholder="Flair text (e.g., 'Discussion)"
                />
                {
                  errors.name && (
